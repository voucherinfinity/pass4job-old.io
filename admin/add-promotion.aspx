<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminpage.master" AutoEventWireup="true" CodeBehind="add-promotion.aspx.cs" Inherits="SLI.admin.add_promotion" %>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <asp:Button ID="btnsubmit" runat="server" Text="Update Promotion" CssClass="btn btn-info btn-fill" OnClick="btnsubmit_Click" />
                <hr>
