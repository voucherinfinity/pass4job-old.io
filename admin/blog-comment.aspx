<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminpage.master" AutoEventWireup="true" CodeBehind="blog-comment.aspx.cs" Inherits="SLI.admin.blog_comment" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title pull-left">Blog Comment Details</h4>
                                ...
                                <asp:Repeater ID="RepDetails" runat="server" OnItemCommand="RepDetails_ItemCommand">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%#Eval("Comment") %></td>
                                            <td>
                                                <asp:DropDownList ID="ddCommentStatus" runat="server" OnSelectedIndexChanged="SelectedIndexChange_ddCommentStatus" AutoPostBack="true" class="form-control">
