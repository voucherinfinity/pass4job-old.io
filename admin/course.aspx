<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminpage.master" AutoEventWireup="true" CodeBehind="course.aspx.cs" Inherits="SLI.admin.course" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title pull-left">Course Details</h4>
                        <a href="add-courses.aspx" class="btn btn-info btn-fill pull-right">Add Course</a>
