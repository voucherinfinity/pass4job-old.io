<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminpage.master" AutoEventWireup="true" CodeBehind="vendor.aspx.cs" Inherits="SLI.admin.vendor" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title pull-left">Vendor Details</h4>
                        <a href="add-vendor.aspx" class="btn btn-info btn-fill pull-right">Add Vendor</a>
