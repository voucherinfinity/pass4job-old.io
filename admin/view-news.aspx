<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminpage.master" AutoEventWireup="true" CodeBehind="view-news.aspx.cs" Inherits="SLI.admin.view_news" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title pull-left">News Details</h4>
                        <a href="news.aspx" class="btn btn-info btn-fill pull-right">Add News</a>
